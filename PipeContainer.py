...
class PipeContainer:
    ...
    def __init__(self, asset_factory, game_configuration):
        ...
        self._max_num_pipes = int(self._game_configuration.window_width / (self._game_configuration.pipe_width + self._game_configuration.pipe_distance)) * PipeContainer.NUM_PIPE_PARTS + 2 # Add 2 for some leeway
    ...
    def update(self, surface):
        ...
        num_sprites_to_add = self._max_num_pipes - len(self.pipe_group.sprites())
